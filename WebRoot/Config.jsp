...
<bbData:context id="ctx">
    ...
    <bbUI:docTemplate title="<%= page_title%>">
        ...
        <form name="instanceForm">
            <%=blackboard.platform.plugin.PlugInUtil.getConfigDirectory("ppto", "PanoptoCourseTool") %>
        ...
        <div class="form">
            <div class="steptitle submittitle" id="steptitle3">
                ...
                Provision Panopto Courses & Communities
            </div>
            <div class="stepcontent" id="step3">
                        ...
                        <li>
                            <div class="field">
                                ...
                                <p tabIndex="0" class="stepHelp">
                                    ...
                                    <% /*com.panopto.blackboard.Utils.log("inside config.jsp");*/ %>
                                </p>
                            </div>
                        </li>
                        <%
                        ...
                        <li>
                            ...
                            <script type="text/javascript">
                                function launchCoursePicker()
                                {
                                    ...
                                    var top = 20;						
                                    var left = 20; // Math.max(screen.width - 0, 0);
                ...
                <div class="stepcontent" id="step3-">-->
                <form name="batchProvisionFormC" action="Course_Provision.jsp" method="post">
                    <ol>
                        <li>
                            <div class="field">
                                <h1>Communities</h1>
                        ...
                        <li>
                            ...
                            <!-- Function to launch built-in Blackboard course selection widget in a popup window. -->
                            <script type="text/javascript">
                                function launchCommunityPicker()
                                {
                                    // 1280x800 popup window (clipped to available screen size).
                                    var width = Math.min(1300, screen.width);
                                    var height = Math.min(800, screen.height);
                                    ...
                                    // Position against the right edge of the screen, with top margin of 20px.
                                    var top = 20;						
                                    var left = 20; //Math.max(screen.width - 1300, 0);
                                                                                
                                    // Open the popup window
                                    var courseSelectWindow = window.open('communities/frameset.jsp','course_browse','width='+width+',height='+height+',resizable=yes,scrollbars=yes,status=yes,top='+top+',left='+left);
                                    ...
                                    if (courseSelectWindow != null)
                                    {
                                        ...
                                        if (courseSelectWindow.opener == null) courseSelectWindow.opener = self;
                                        // Identify the form control to populate with the selected courseIds
                                        courseSelectWindow.opener.inputToSet = document.forms.batchProvisionFormC.bbCourses;
                        ...
                        <li class="required">
                            ...
                            <div class="field">
                                <!-- Comma-delimited list of Blackboard courseIds to provision, populated by Blackboard course picker widget. -->
                                <input type="text" name="bbCourses"> 
                                <input type="button" value="Browse..." onclick="launchCommunityPicker()" name="browse">
                                <br />
                                <span tabIndex="0" class="stepHelp">Community IDs may be entered as a comma separated list.</span>
                                <br />
                                <input name="add" class="secondary" type="submit" border="0" hspace="5" value="Add"/>
                            </div>
                        </li>
